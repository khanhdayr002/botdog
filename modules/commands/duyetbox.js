...
module.exports.run = async  ({ event, api, args, Threads, Users, handleReply  }) => {
  ...
  api.sendMessage(`====『 𝗗𝗨𝗬𝗘𝗧 𝗗𝗘𝗟 』 ====\n━━━━━━━━━━━━━━━━\n[ 👨‍👩‍👧‍👦 ] 𝗻𝗵𝗼́𝗺 ${threadName}\n[🔰] 𝗜𝗗: ${idBox} \n🌟 đ𝗮̃ 𝗯𝗶̣ 𝗴𝗼̛̃ 𝗸𝗵𝗼̉𝗶 𝗱𝗮𝗻𝗵 𝘀𝗮́𝗰𝗵 đ𝘂̛𝗼̛̣𝗰 𝗽𝗵𝗲́𝗽 𝘀𝘂̛̉ 𝗱𝘂̣𝗻𝗴 𝗕𝗼𝘁`, threadID, () => {
	...
	const fs = require("fs");
      ...
      axios.get('https://lon-1.mhieu14012008.repl.co/video/anime').then(res => {
...
→ 𝗠𝗼̣𝗶 𝘁𝗵𝗮̆́𝗰 𝗺𝗮̆́𝗰 𝗰𝘂̛́ 𝗹𝗶𝗲̂𝗻 𝗵𝗲̣̂ 𝗮𝗱𝗺𝗶𝗻 𝗯𝗼𝘁: https://www.facebook.com/User.HieuSimpRin
━━━━━━━━━━━━━━━━━━
→ 𝗧𝗵𝗶𝘀 𝗯𝗼𝘁 𝗺𝗮𝗱𝗲 𝗯𝘆: 𝐓𝐫𝐮𝐧𝐠 𝐇𝐢𝐞̂́𝐮
→ 𝗧𝗵𝗮𝗻𝗸 𝘆𝗼𝘂 𝗳𝗼𝗿 𝘂𝘀𝗶𝗻𝗴
